...
export const getEmployees = async (pageOrOptions = {}, pageSize = 10, actualPageSize = 10) => {
  let params;
  if (typeof pageOrOptions === 'object') {
    params = { page: pageOrOptions.page || 1, pageSize: pageOrOptions.pageSize || 10 };
  } else {
    params = { page: pageSize || 1, pageSize: actualPageSize || 10 };
  }
